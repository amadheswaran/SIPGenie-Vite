...
export default function Home() {
  useEffect(()=>{ document.title = 'Home — SIPGenie'; const meta = document.querySelector('meta[name="description"]'); if(meta) meta.setAttribute('content','SIPGenie — smart SIP calculator and comparison tools'); const kw = document.querySelector('meta[name="keywords"]'); if(kw) kw.setAttribute('content','SIP calculator, compare SIP, mutual funds, SIP calculator India'); }, []); {
